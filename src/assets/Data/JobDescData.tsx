import { IconBriefcase, IconCash, IconMapPin, IconTie } from "@tabler/icons-react"

const card=[
    {name:"Location", icon:IconMapPin, value:"New York" , id:"location"},
    {name:"Experience", icon:IconTie, value:"Expert" , id:"experience"},
    {name:"Salary", icon:IconCash, value:"48 LPA" , id:"packageOffered"},
    {name:"Job Type", icon:IconBriefcase, value:"Full Time" , id:"jobType"},
]
