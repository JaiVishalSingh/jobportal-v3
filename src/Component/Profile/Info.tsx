    ...
    <div className="px-3 mt-24">
      ...
      </div>
      {
        ...
        <div className="flex gap-10 [&>*]:w-1/2">
          ...
          <NumberInput withAsterisk label="Experience" placeholder= "Enter Your Experience" hideControls clampBehavior="strict" min={0} max={50} {...form.getInputProps('totalExp')} />
        </div>
